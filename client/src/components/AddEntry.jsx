        ...
        <div>
          <table>
            <tbody>
              ...
              <tr className='mytablerows'>
                <td>
                  <div onChange={onChangeValue} style={{ display: "" }}>
                    <div><input type="radio" value="Single" name="status" /> Single</div>
                    <div><input type="radio" value="Taken" name="status" /> Taken</div>
                    <div><input type="radio" value="Complicated" name="status" /> Complicated</div>
                  </div>
              ...
              <tr className='mytablerows'>
                ...
                <td>
                  <input onChange={changeTextContact} value={contactinput} placeholder='e.g username or number' type="text" style={{ borderColor: 'rgba(0,0,0,0.2)' }} className='mytextfield'></input>
                </td>
              </tr>
